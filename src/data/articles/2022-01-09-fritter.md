...
リストに含まれるユーザの screen\_name の一覧は [TweetDeck](https://tweetdeck.twitter.com/) の "Edit List" で開くモーダルから得られた．id は [TweeterID - Twitter ID and username converter](https://tweeterid.com/) を使って取得することにした．
