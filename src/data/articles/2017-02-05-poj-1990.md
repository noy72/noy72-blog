...
- iが与えられたとき、a\_1からa\_iまでの和を求める。
- (iとjが与えられたとき、a\_iからa\_jまでの和を求める。)
- iとxが与えられたとき、 a\_i += x する。
...
距離の差の総和 = 区間 0\~x−1 にいる牛の数 * x - 区間0\~x−1にいる牛の座標の総和 + 区間x\~MAX\_Xにいる牛の座標の総和 - 区間x~MAX\_Xにいる牛の数 * x
